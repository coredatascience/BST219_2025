...
Good visualizations make data easier to understand and interpret. Keep these core principles in mind:

* Choose clarity over decoration: Avoid pie charts—bar charts or dot plots communicate proportions more clearly.
* Start axes appropriately: Always include 0 on bar charts; for scatterplots/line charts, use judgment depending on context.
* Length > Area > Color: Human perception is best at comparing lengths, then areas, then colors—design accordingly.
* Use color wisely:
  * Prefer color-blind–friendly palettes (e.g., viridis, RColorBrewer).
  * Use color to highlight important comparisons, not as decoration.

* Minimize clutter: Remove unnecessary gridlines, 3D effects, or excessive labels.
* Consistency matters: Keep scales, legends, and styles consistent across related plots.

Main point: A good plot communicates the message directly, avoids misleading design choices, and ensures accessibility for all audiences.
